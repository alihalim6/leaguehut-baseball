module.exports = function(module){
	...
	module.constant('pitchConstants', {
		...
		//*****
			...
			//adjusted by adding .4 (6.5/16 OOZ locs) to each out of zone loc number
			//and subtracting .7 (6.5/9 Z locs) from in zone numbers
			...
			//same for swing; nothing off more than a couple % (RL https://www.fangraphs.com/zonegridbase.aspx?playerid=&position=B&ss=&se=&type=2&hand=RL&count=all&blur=0&grid=5&view=pit&pitch=&season=2017&data=pi)
			//contact: (LL https://www.fangraphs.com/zonegridbase.aspx?playerid=&position=B&ss=&se=&type=3&hand=LL&count=all&blur=0&grid=5&view=pit&pitch=&season=2017&data=pi)
			//pitchTypePerc dropdown selections-> FB: FA, FC, FS, SI...SL: SL, KN...CB: CU...CU: CH

			//*****
			//pitchTypePerc is number of pitches thrown at loc
			//relative to the other 3 pitch types at loc
