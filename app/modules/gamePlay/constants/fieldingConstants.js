module.exports = function(module){
	module.constant('fieldingConstants', {
		...
		RC_LC_BASE_DIST : 370,
		CENTER_DIST : 405,
		THROW_TO_CUTOFF_MIN: 260,
		GO_TOWARD_CUTOFF_POINT: -50,
		...
		DEFENSE_POSITIONING_MOVE_MIN : 12,
		DEFENSE_POSITIONING_MOVE_MAX : 20,
		...
		TIME_DIFF_FOR_PROJECTED_BASE_REACH : 1,
		DIST_DIFF_FOR_PROJECTED_BASE_REACH : 3.5,

		MAX_FIELDING_CHANCE_FOR_ERROR: 95,
		...
		BOUNCE_ROLL_FINAL_DIST : {
			...
			//rand range of perc of distance
		...
		//time to reach ball{
			//distance from where ball will be
		//}
		//onHundredMax--distance for which all distances up to it have 100% rate
		CHANCES : {
			"0.5" : {
				"0" : 46
			},
